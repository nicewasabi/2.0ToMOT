...
public class LimitedCache implements ICache {
	...
	private abstract class LimitedIterator<E> implements Iterator<E> {
		...
		public Map.Entry<Object, Object> getNext() {
			LinkedNode n = node;
			node = node.nextNode;
	...
	private final class LimitedEntryIterator extends
			LimitedIterator<Map.Entry<Object, Object>> {
		@Override
	 ...
	 *
	 */
	private final class LimitedEntry implements Map.Entry<Object, Object> {
